...
type GenerateStageReq struct {
	...
	XOREncryptKey string                 `protobuf:"bytes,6,opt,name=XOREncryptKey,proto3" json:"XOREncryptKey,omitempty"`
	PrependSize   bool                   `protobuf:"varint,7,opt,name=PrependSize,proto3" json:"PrependSize,omitempty"`
	CompressF     string                 `protobuf:"bytes,8,opt,name=CompressF,proto3" json:"CompressF,omitempty"`
	Compress      string                 `protobuf:"bytes,9,opt,name=Compress,proto3" json:"Compress,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GenerateStageReq) GetXOREncryptKey() string {
	if x != nil {
		return x.XOREncryptKey
	}
	return ""
}
...
const file_clientpb_client_proto_rawDesc = "" +
	...
	"\rXOREncryptKey\x18\x06 \x01(\tR\rXOREncryptKey\x12 \n" +
	"\vPrependSize\x18\a \x01(\bR\vPrependSize\x12\x1c\n" +
	"\tCompressF\x18\b \x01(\tR\tCompressF\x12\x1a\n" +
	"\bCompress\x18\t \x01(\tR\bCompress\".\n" +
	"\bGenerate\x12\"\n" +
